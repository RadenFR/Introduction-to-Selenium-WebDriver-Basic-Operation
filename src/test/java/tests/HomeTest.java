...
public class HomeTest extends BaseTest {
    ...
    @Test(priority = 4, groups = {"smoke"}, description = "Test successful Add to Cart in Home Page", retryAnalyzer = core.RetryAnalyzer.class)
    public void testSortByNameZtoA() {
        ...
        logger.info("User klik button filter");
